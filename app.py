...
def model_predict2(image_path,model):
    ...
    if result == 0:
        return "BENIGN IN WBC","after.html"        
    elif result == 1:
        return "EARLY STAGE OF MALIGNANT IN WBC","after.html"
    elif result == 2:
        return "PRE STAGE OF MALIGNANT IN WBC","after.html"
    elif result == 3:
        return "POST STAGE OF MALIGNANT IN WBC","after.html"
